var vendor = {
    ...
    list_vendor: function (e) {
        ...
        $('#vendor_table').DataTable({
            "ajax": {
                "url": this.base_url + `/vendor/list_vendor_by_approve_status/1/${level_status}`,
                "type": "GET",
                "datatype": "json"
            },
            "buttons": [
    ...
    send_link: function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                var $request = $.ajax({
                    url: `${vendor.base_url}/vendor/resend_revert_to_vendor`,
                    type: "Post",
                    dataType: "json",
                    contentType: "application/json",
                    data: JSON.stringify(obj),

var vendor = {
    ...
    add_vendor: function (e) {
        ...
        obj.code_of_conduct = forward_url

        obj.it_deceleration = revert_url
    ...
    upload_revert_attachment_files: function (e) {
        ...
        $request.done(async function (response) {
            if (response.status == true) {
                ...
                var img = ""
                project_img_array.map(info => {
                    img += `<div class="mx-1 remove_img_section revert_array_class"><img src="${vendor.base_url}/images/pdf.png" class="get_img_section" data-img='${info}'   width=100px alt="Img">
                    <a class="a_tag" download="new-filename"><i class="fa-check" style="cursor: pointer;" data-img-name='${info}' onclick="vendor.remove_project_images(this)">X</i></a>
                    </div>`
